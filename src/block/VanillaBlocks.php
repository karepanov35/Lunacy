...
final class VanillaBlocks{
	...
	protected static function register(string $name, \Closure $createBlock, ?string $tileClass = null) : Block{
		...
		if(!is_int($typeId)){
			...
			\GlobalLogger::get()->debug(self::class . ": No constant type ID found for $name, generating a new one");
	...
	protected static function setup() : void{
		...
		self::register("obsidian", fn(BID $id) => new Obsidian($id, "Obsidian", new Info(BreakInfo::pickaxe(35.0 /* 50 in PC */,  ToolTier::DIAMOND, 6000.0))));
