...
use pocketmine\updater\GitHubReleaseCheckTask;
...
class Server{
	...
	private ?AuthKeyProvider $authKeyProvider = null;
	...
	public function __construct(
		...
		try{
			...
			$this->asyncPool = new AsyncPool($poolSize, max(-1, $this->configGroup->getPropertyInt(Yml::MEMORY_ASYNC_WORKER_HARD_LIMIT, 512)), $this->autoloader, $this->logger, $this->tickSleeper);
			...
			$this->getAsyncPool()->submitTask(new GitHubReleaseCheckTask($this));
	...
	public function getAuthKeyProvider() : ?AuthKeyProvider{
		return $this->authKeyProvider ?? null;
	}
