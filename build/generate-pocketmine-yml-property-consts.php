...
$lunacyYmlPath = dirname(__DIR__) . '/resources/' . Config::LUNACY_YML;
$content = Config::stripPhpHeader(Filesystem::fileGetContents($lunacyYmlPath));
$content = Config::fixYAMLIndexes($content);
$defaultConfig = yaml_parse($content);

if(!is_array($defaultConfig)){
	fwrite(STDERR, "Invalid default " . Config::LUNACY_YML . "\n");
	exit(1);
}
