...
class ChunkCache implements ChunkListener{
	...
	public static function getInstance(World $world, Compressor $compressor) : self{
		...
		if(!isset(self::$instances[$worldId][$compressorId])){
			...
			$dimensionId = self::getDimensionIdForWorld($world);
	...
	public static function getDimensionIdForWorld(World $world) : int{
		// ╨Ю╨┐╤А╨╡╨┤╨╡╨╗╤П╨╡╨╝ dimension ID ╨▓ ╨┐╨╡╤А╨▓╤Г╤О ╨╛╤З╨╡╤А╨╡╨┤╤М ╨┐╨╛ ╨│╨╡╨╜╨╡╤А╨░╤В╨╛╤А╤Г (╤Б╨╛╨┤╨╡╤А╨╢╨╕╨╝╨╛╨╡ ╨╝╨╕╤А╨░),
		// ╨╕╨╜╨░╤З╨╡ ╨┐╨╛ ╨╕╨╝╨╡╨╜╨╕ ╨┐╨░╨┐╨║╨╕. ╨Ш╨╜╨░╤З╨╡ ╨┐╤А╨╕ ╨╜╨╡╤Б╨╛╨▓╨┐╨░╨┤╨╡╨╜╨╕╨╕ (╨┐╨░╨┐╨║╨░ "world" + ╨│╨╡╨╜╨╡╤А╨░╤В╨╛╤А nether)
		// ╨║╨╗╨╕╨╡╨╜╤В ╨┐╨╛╨╗╤Г╤З╨░╨╗ ╨▒╤Л dimension OVERWORLD, ╨╜╨╛ ╨▒╨╗╨╛╨║╨╕ тАФ ╨╜╨╡╨╖╨╡╤А╨░╨║, ╨╕ ╤З╨░╤Б╤В╨╕╤Ж╤Л ╨┐╨╛╨╗╨╛╨╝╨║╨╕ ╨╛╤В╨╛╨▒╤А╨░╨╢╨░╨╗╨╕╤Б╤М ╨▒╤Л ╨╜╨╡╨┐╤А╨░╨▓╨╕╨╗╤М╨╜╨╛.
