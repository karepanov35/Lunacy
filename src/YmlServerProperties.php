...
/**
 * @internal
 * Constants for all properties available in lunacy.yml.
...
final class YmlServerProperties{
	...
	public const CHUNK_SENDING_BURST_PER_TICK = 'chunk-sending.burst-per-tick';
	public const CHUNK_SENDING_ADAPTIVE = 'chunk-sending.adaptive';
	...
	public const CHUNK_UNLOADING = 'chunk-unloading';
	public const CHUNK_UNLOADING_DELAY_SECONDS = 'chunk-unloading.delay-seconds';
	public const CHUNK_UNLOADING_PER_TICK = 'chunk-unloading.per-tick';
	public const CHUNK_UNLOADING_ADAPTIVE = 'chunk-unloading.adaptive';
	...
	public const ENTITY_MAX_TICKED_PER_TICK = 'entity.max-ticked-per-tick';
	...
	public const NETWORK_MIN_PROTOCOL = 'network.min-protocol';
