...
use pocketmine\world\generator\overworld\decorator\AmethystGeodeDecorator;
use pocketmine\world\generator\overworld\decorator\DripstoneCaveDecorator;
use pocketmine\world\generator\overworld\decorator\LushCaveDecorator;
...
class BiomePopulator implements VanillaPopulator{
	...
	protected AmethystGeodeDecorator $amethyst_geode_decorator;
	protected DripstoneCaveDecorator $dripstone_cave_decorator;
	protected LushCaveDecorator $lush_cave_decorator;
	...
	public function __construct(){
		...
		$this->amethyst_geode_decorator = new AmethystGeodeDecorator();
		$this->dripstone_cave_decorator = new DripstoneCaveDecorator();
		$this->lush_cave_decorator = new LushCaveDecorator();

		array_push($this->in_ground_populators,
			$this->water_lake_decorator,
			$this->lava_lake_decorator,
			$this->surface_cave_decorator,
			$this->amethyst_geode_decorator,
			$this->dripstone_cave_decorator,
			$this->lush_cave_decorator,
			$this->ore_populator,
	...
	protected function initPopulators() : void{
		...
		$this->amethyst_geode_decorator->setAmount(1);
		$this->dripstone_cave_decorator->setAmount(1);
		$this->lush_cave_decorator->setAmount(1);
		...
		$this->sugar_cane_decorator->setAmount(11);
