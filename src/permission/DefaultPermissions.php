...
abstract class DefaultPermissions{
	...
	public static function registerCorePermissions() : void{
		...
		// This custom permission doesn't have a generated translation key in KnownTranslationParameterInfo.
		self::registerPermission(new Permission(Names::COMMAND_BIOME, "Allows using /biome"), [$operatorRoot]);
